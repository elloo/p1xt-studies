...
Settled on creating a website based off the idea of commonplace books. 
- Todos:
...
### Day 30
```diff
+ Completed CSS and Bootstrap styling
+ Submitted final project through Github
    Still need to create video submission
+ Revised and took notes on course material 
    Focused on data structures and how the internet works.    
```

### Day 31
```diff
+ Completed final submission video 
    AND with that I've completed CS50!
+ Setup Git and Brackets on my PC to make use of my wide-screen monitor.
+ Began reviewing Shay Howe's HTML and CSS course while working on a template clone.
    Completed HTML structure for index.html
    Completed rough positioning for index.html
```